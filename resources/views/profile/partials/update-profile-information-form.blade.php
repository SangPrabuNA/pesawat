<section>
    ...
    {{-- Tambahkan enctype untuk form upload --}}
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            <x-input-label for="signature" :value="__('Tanda Tangan (Gambar)')" />
            ...
            @if ($user->signature)
                <div class="mt-4">
                    ...
                    <img src="{{ asset('storage/' . $user->signature) }}" alt="Tanda Tangan" class="mt-2 h-20 rounded-md border border-gray-300">
                </div>
            @endif
        </div>
